...
export class AppPrescription {
                  ...
                  <div class="card h-100 border-0 rounded-0 card-info">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <label htmlfor="texArea">Example textarea</label>
  ...
  saveNewPrescription(e){
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        console.log(this.idPatient,this.idDoctor,this.prescription)
  ...
  async savePrescri(data){
    let result = await fetch('http://localhost:8485/prescription',{
      method:'POST',
      body:data
    }).then(resp =>{
      return resp.json()
