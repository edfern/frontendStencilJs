...
export class AppSearch {
  ...
  @Method()
  async getPatients(){
    let data = await fetch('http://localhost:8485/patient?'+ new URLSearchParams({
      type:'patientsName',
  ...
  @Method()
  async getHisotory(){
    let data = await fetch('http://localhost:8485/medicalHistory?'+ new URLSearchParams({
  ...
  async getPrescriptions(){
    let data = await fetch('http://localhost:8485/prescription?'+ new URLSearchParams({
