...
export class AppMeetingNew {
        ...
        <div class="card h-100 border-0 rounded-0">
          ...
          <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" id="inputName" class="form-control rounded-0" placeholder="Juan Perez" value={this.name} required/>
  ...
  async saveNewMeetingPatient(){
    ...
    let data = await fetch('http://localhost:8485/appointment',{
      method:'POST',
      body:body
    }).then(resp =>{
      return resp.json()
  ...
  async deleteMeetingPatient(){
    let data = await fetch('http://localhost:8485/appointment?idAppointment='+this.data.idAppointment,{
      method:'DELETE'
    }).then(resp =>{
      return resp.json()
    }).then(data =>{
  ...
  async deleteMeetingGuest(){
    let data = await fetch('http://localhost:8485/guestAppointment?'+new URLSearchParams({
  ...
  async saveNewMeetingGuest(){
    let data = await fetch('').then(resp =>{
      return resp.json()
    }).then(data =>{
      return data;
    }).then(error =>{
